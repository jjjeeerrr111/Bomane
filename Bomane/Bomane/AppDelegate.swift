...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func initWindow(controller: String) {
        ...
        let controllerDic = ["About" : AboutViewController.shared, "Services":ServicesViewController.shared, "Portfolio" : ProtfolioViewController.shared, "Book Appointment" : BookAppointmentViewController.shared]
